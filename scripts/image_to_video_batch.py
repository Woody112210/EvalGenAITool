...
PROMPT_FILE = "./prompts/image2video_prompts.csv" 
...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, f"image_to_video_results_{TIMESTAMP}.csv")
...
def image_to_video(model_path, prompt, image_path, extra_args=None):
...
def main():
    ...
    models = config.get("image_to_video_models", {})
    ...
    for idx, row in df.iterrows():
        ...
        for model_name, model_info in models.items():
            ...
            try:
                result_url = image_to_video(model_path, prompt, image_path, params)
